function love.conf(t)
    t.identity = "nethacker"                   -- The name of the save directory (string)
    t.version = "0.10.0"                -- The LÖVE version this game was made for (string)
    t.console = false                  -- Attach a console (boolean, Windows only)

    t.window.title = "Nethacker"        -- The window title (string)
...
config = {
    ...
    font = 'assets/font/SourceCodePro-Regular.ttf',
    fontBold = 'assets/font/SourceCodePro-Bold.ttf',
    fontLight = 'assets/font/SourceCodePro-Light.ttf',
}
